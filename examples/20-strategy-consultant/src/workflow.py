"""
Strategy consultant -- tool-augmented market analysis.

A LangGraph ReAct agent uses three mock research tools to gather
market data, then structures a MarketAnalysis verdict.
"""
import json
