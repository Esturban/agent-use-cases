...
| 46 | [Bank Reconciliation Agent](./examples/46-bank-reconciliation-agent/README.md) | Matches bank statement lines against the GL cash account and classifies unmatched items as timing differences, bank errors, or potential fraud | Finance, Accounting, Controls | Intermediate | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Esturban/agent-use-cases/blob/main/examples/46-bank-reconciliation-agent/bank_recon_workbook.ipynb) |
| 47 | [Expense Audit Agent](./examples/47-expense-audit-agent/README.md) | Tests expense lines against a configurable policy ruleset and routes violations to the correct approver tier by severity | Finance, Accounting, Compliance | Intermediate | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Esturban/agent-use-cases/blob/main/examples/47-expense-audit-agent/expense_audit_workbook.ipynb) |
| 48 | [AR Collection Agent](./examples/48-ar-collection-agent/README.md) | Segments receivables by aging bucket and drafts a tone-calibrated, escalating collection plan per customer | Finance, Accounts Receivable | Intermediate | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Esturban/agent-use-cases/blob/main/examples/48-ar-collection-agent/ar_collection_workbook.ipynb) |
| 49 | [Month-End Close Orchestrator](./examples/49-month-end-close-orchestrator/README.md) | Dispatches close tasks in dependency order, surfaces blocked-task reasons and delay, and re-derives the critical path after every status change | Finance, Accounting, Controls | Advanced | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Esturban/agent-use-cases/blob/main/examples/49-month-end-close-orchestrator/month_end_close_orchestrator_workbook.ipynb) |
...
| 90 | [Approval Gate Pattern](./examples/90-approval-gate-pattern/README.md) | Interrupt-and-resume human approval gate — a routing label is not a gate; LangGraph's `interrupt()`/`Command(resume=...)` actually pauses execution | Intermediate | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Esturban/agent-use-cases/blob/main/examples/90-approval-gate-pattern/approval_gate_workbook.ipynb) |
| 91 | [Security Operations Supervisor](./examples/91-security-operations-supervisor/README.md) | Hierarchical conditional dispatch — only domains with active signal run, and P0/P1 findings gate through the approval-gate pattern before they're actionable | Advanced | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Esturban/agent-use-cases/blob/main/examples/91-security-operations-supervisor/security_operations_workbook.ipynb) |
